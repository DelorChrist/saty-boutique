...
router.route('/')
    ...
    .post(authenticate, authorize('admin'), upload.array('images', 5), verifyMagicNumber, optimizeImage, createProductValidation, productController.createProduct);

router.route('/:id')
    .get(productController.getProductById)
    .put(authenticate, authorize('admin'), upload.array('images', 5), verifyMagicNumber, optimizeImage, updateProductValidation, productController.updateProduct)
